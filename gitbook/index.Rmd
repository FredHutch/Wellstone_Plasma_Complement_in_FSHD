...
data.frame(dataset = c("table_1.rda", "table_2.rda", 
           ...
           description=c("first cohort",
                         "second cohort",
                         "discovery cohort including selected samples from first and second cohorts",
                         "comprehensive set of first and second cohorts and re-run samples")) %>%
